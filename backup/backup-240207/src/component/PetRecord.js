...
const PetRecord = ({
  ...
  const [temperature, setTemperature] = useState("low");
  ...
  return (
    <div className="PetRecord">
      <RadioGroup
        ...
        onChange={setCough}
      >
        <Radio name={"cough"} value="1~3" defaultChecked>
          1~3회
        </Radio>
        <Radio name={"cough"} value={"4~6"}>
          4~6회
        </Radio>
        <Radio name={"cough"} value={"7~"}>
          7회 이상
        </Radio>
      </RadioGroup>
      <RadioGroup
      ...
      >
        <Radio name={"runningNose"} value={"transparent"} defaultChecked>
          투명함
        </Radio>
      ...
      <RadioGroup
        ...
        onChange={setHunger}
      >
        <Radio name={"hunger"} value={"reduced"} defaultChecked>
          감소
        </Radio>
      ...
      <RadioGroup
        ...
        onChange={setUrine}
      >
        <Radio name={"urine"} value={"0~2"} defaultChecked>
          0~2회
        </Radio>
      ...
      >
        <Radio name={"excrement"} value={"0"} defaultChecked>
          0회
        </Radio>
      ...
      >
        <Radio name={"temperature"} value={"low"} defaultChecked>
          평균보다 낮음
        </Radio>
        <Radio name={"temperature"} value={"normal"}>
          평균
        </Radio>
        <Radio name={"temperature"} value={"high"}>
          평균보다 높음
        </Radio>
      </RadioGroup>
      <RadioGroup
        ...
        onChange={setActive}
      >
        <Radio name={"active"} value={"none"} defaultChecked>
          거의 없음
        </Radio>
