    ...
    return (
      <div className="HospitalFilterModal">
        <div className="modalTop">
          <span
            className="material-symbols-outlined closeModalBtn"
        ...
        <div className="possPet">
          ...
          <div>
            ...
            <FilterCheckBox
              value={"고슴도치"}
              check={hadgehog}
              onClick={() => changeHadgehog()}
              onChange={checkboxHandle}
            />
            <FilterCheckBox
              value={"기니피그"}
              check={guineaPig}
              onClick={() => changeGuineaPig()}
              onChange={checkboxHandle}
            />
            <FilterCheckBox
              value={"거북이"}
              check={turtle}
              onClick={() => changeTurtle()}
              onChange={checkboxHandle}
            />
            <FilterCheckBox
              value={"페럿"}
              check={ferret}
              onClick={() => changeFerret()}
              onChange={checkboxHandle}
            />
            <FilterCheckBox
              value={"조류"}
